...
export async function POST(context: APIContext) {
  try {
    ...
    // NOT: Klasör silme funksionallığı devre dışı bırakıldı
    // Çünkü bir şəkil silindikdə bütün folder silinirdi və digər şəkillər də itirdi
    // Klasörler boş qaldıqda manuel olaraq və ya ayrı bir cleanup işlemi ilə silinməlidir
    
    console.log('⚠️ Klasör silmə deaktivdir - yalnız şəkillər silindi');
