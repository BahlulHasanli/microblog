...
export default function AvatarSelector({ currentAvatar, onAvatarSelect }: AvatarSelectorProps) {
  ...
  return (
    <div className="avatar-selector">
      <h3 className="text-base font-medium text-base-700 mb-3">Profil şəkli seçin</h3>
