            ...
            >
              ...
              {isOwner && (
                <button
                  ...
                  className="cursor-pointer absolute backdrop-blur-sm inset-0 flex items-center justify-center bg-black/30 brightness-110 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
